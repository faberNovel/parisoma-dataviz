...
var list = [
  ...
  `<div>PARISOMA is a space where ideas meet execution. We foster an experimental environment through coworking, classes, and events.<a class='download' download='true' href="PARISOMA-Infographic-2014.pdf" download>Download the infographic</a></div>`
];
...
function _createLayout(){
  ...
  this.buildingImg.surface = new ImageSurface({
    content: require('../../assets/images/14-building.png'),
    size: [true, true]
  });
  ...
  this.info.surface = new Surface({
    content: `
    <div class='contact'>
      <a href='https://maps.google.com/maps?q=PARISOMA,+169+11th+Street,+San+Francisco,+CA&hl=en&ll=37.775142,-122.414882&spn=0.00982,0.01929&sll=37.775447,-122.414882&sspn=0.00982,0.01929&hq=PARISOMA,+169+11th+Street,+San+Francisco,+CA&t=m&z=16'>169 11th street, San Francisco, CA 94103</a>
  ...
  this.tagline = {};
  this.tagline.surface = new Surface({
    content: list[3]
  });
...
function Slide() {
  ...
  this._steps = [
    ...
    function() {
      this.arrow.modifier.setOpacity(0);
      this.tagline.modifier.setOpacity(1);
...
Slide.prototype.didEnter = function() {
  if (this.hasAnimated) {
    this.buildingImg.modifier.setOpacity(1);
    this.buildingImg.modifier.setOpacity(1);
    this.tagline.modifier.setOpacity(0);
    this.list.modifier.setOpacity(1);
    this.info.modifier.setTransform(Transform.translate(-360, 334, 0));
