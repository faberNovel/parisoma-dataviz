...
Slide.prototype.didEnter = function() {
  if (this.hasAnimated) {
    ...
    setTimeout(this.playNextAnimation.bind(this, -1), 4000);
    setTimeout(this.playNextAnimation.bind(this, 1), 6000);
    setTimeout(this.playNextAnimation.bind(this, 2), 8000);
    setTimeout(this.playNextAnimation.bind(this, 3), 10000);
  }
};
