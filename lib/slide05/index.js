...
function _createLayout(){
  ...
  this.parisomaImg.surface = new ImageSurface({
    content: require('url!../../assets/images/07-parisoma.png'),
    size: [true, true]
  });
  ...
  this.shelfImg.surface = new ImageSurface({
    content: require('url!../../assets/images/06-shelf.png'),
    size: [true, true]
  });
  ...
  this.keyboardImg.surface = new ImageSurface({
    content: require('url!../../assets/images/08-keyboard.png'),
    size: [true, true]
  });
  ...
  this.donutImg.surface = new ImageSurface({
    content: require('url!../../assets/images/10-donut.png'),
    size: [true, true]
  });
  ...
  this.taglineImg.surface = new ImageSurface({
    content: require('url!../../assets/images/09-tagline.png'),
    size: [true, true]
  });
